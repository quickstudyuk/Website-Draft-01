    ...
    <section style={{ 
      ...
      <div className="container" style={{ maxWidth: '1100px', position: 'relative', zIndex: 1 }}>
        ...
        <div style={{ textAlign: 'center', marginBottom: 'var(--spacing-12)' }}>
          ...
          <h2 style={{ fontSize: 'clamp(2rem, 4vw, 3rem)', fontWeight: 800, color: '#0f172a', margin: '0 0 12px 0', letterSpacing: '-0.02em' }}>
            More Than Subject Tuition
          </h2>
          <p style={{ color: '#475569', fontSize: '1.1rem', maxWidth: '650px', margin: '0 auto', lineHeight: 1.6 }}>
            Every subject is supported by the full power of the QuickStudy Learning Environment.
          </p>
        </div>
        ...
        <div style={{
          ...
          gap: 'var(--spacing-12)',
          alignItems: 'center'
        }} className="qle-integration-grid">
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 'var(--spacing-4)' }}>
            {integrationStates.map((state, idx) => {
              ...
              return (
                ...
                >
                  <h3 style={{ fontSize: '1.25rem', fontWeight: 800, color: isActive ? '#0f172a' : '#64748b', marginBottom: '6px', transition: 'color 0.3s ease' }}>
                    {state.title}
                  </h3>
                  {isActive && (
          ...
          <div style={{ display: 'flex', flexDirection: 'column', width: '100%', alignItems: 'center' }}>
            ...
            <p style={{ 
              ...
              textAlign: 'center',
              opacity: 0.95,
              height: '16px' // fix height to prevent jumping
            }}>
              {integrationStates[activeIndex].label}
            </p>
